...
### Binding free energies, enthalpies, and entropies

Despite having far fewer numerical parameters, SMIRNOFF99Frosst does about as well as, or even better than, GAFF v1.7 on predicting ΔG and ΔH, compared to the experimental values measured using isothermal titration calorimetry. SMIRNOFF99Frosst has an overall deviation from experiment under 1 kcal/mol on binding free energies and under 2 kcal/mol on binding enthalpies and entropies across the 43 host-guest systems (@fig:dG-dH, @fig:TdS, and Table @tbl:statistics).
