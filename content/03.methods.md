...
Table: The 43 unique host-guest combinations used in this study. The formal charge of each guest is listed in brackets. The guest names correspond to Tables 1 and 2 in Rekharsky et al. [@doi:10.1021/jp962715n]. ^a^ Only the *R* enantiomer was considered. ^b^ Only the *S* enantiomer was considered. SMKILES strings are written as canonical isomeric SMILES as implemented in the OpenEye `OEChem` Toolkit version 2.0.2 [@raw:openeye]. {#tbl:host-guests}
