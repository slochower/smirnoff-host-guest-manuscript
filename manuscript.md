...
### Statistics
The uncertainty in the work done by each restraint in each simulation window, $\left( \frac{\partial U}{\partial \lambda_i} \right)_\text{SEM}$, was estimated using blocking analysis [@htck51Lp].
